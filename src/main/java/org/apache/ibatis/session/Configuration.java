...
public class Configuration {
  ...
  protected final IncompleteResolvers incompleteResolvers = new IncompleteResolvers();
  ...
  public void parsePendingMethods(boolean reportUnresolved) {
    incompleteResolvers.parsePendingMethods(reportUnresolved);
  }

  public void parsePendingStatements(boolean reportUnresolved) {
    incompleteResolvers.parsePendingStatements(reportUnresolved);
  }

  public void parsePendingCacheRefs(boolean reportUnresolved) {
    incompleteResolvers.parsePendingCacheRefs(reportUnresolved);
  }
